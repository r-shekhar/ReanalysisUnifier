...
wget 'ftp://ftp.cdc.noaa.gov/Datasets/cmap/enh/precip.mon.mean.nc'

echo ""
echo "Xie, P., and P.A. Arkin, 1997: Global precipitation: A 17-year monthly analysis based on gauge observations, satellite estimates, and numerical model outputs. Bull. Amer. Meteor. Soc., 78, 2539 - 2558."
echo ""
